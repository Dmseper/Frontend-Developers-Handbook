...
socialNetwork.notify("Новое сообщение");   // [Alice] Получено уведомление: Новое сообщение
                                                // [Bob] Получено уведомление: Новое сообщение
                                               // [Charlie] Получено уведомление: Новое сообщение

socialNetwork.unsubscribe(user2);

socialNetwork.notify("Новый комментарий на вашем посте");  // [Alice] Получено уведомление: Новый комментарий на вашем посте
