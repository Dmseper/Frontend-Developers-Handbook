// Cистема обработки заявок на техническую поддержку, в которой каждая заявка проходит
// через ряд шагов для ее обработки. Реализовать паттерн "Цепочка обязанностей" для
// последовательной обработки заявок и определения подходящего обработчика для каждого шага.
